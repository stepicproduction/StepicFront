...
const PublicitePage = () => {
  ...
  const fetchOffre = async () => {
    try {
      const response = await getData("services/by_categorie/4/")
      console.log(response.data)
      setOffrePublicite(response.data)
    } catch(err) {
