        ...
        >
          ...
          >
            <Button
              ...
              whileTap={{ scale: 0.95 }}
              className="flex items-center justify-center gap-2 px-6 py-2 rounded-full text-[#0B1D5D] border border-[#0B1D5D] hover:bg-[#0B1D5D] hover:text-white shadow-lg transition-all duration-300 h-14 w-40 md:h-12 md:w-48 cursor-pointer"
            >
              Lire plus
            </Button>
          </motion.div>
