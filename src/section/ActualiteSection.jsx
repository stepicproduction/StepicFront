...
import actualite1 from "../assets/actu1.jpg"
...
function ActualiteSection() {
  ...
  return (
    <div id="actualite" className="py-10 px-4 sm:px-8 md:py-20 md:px-32 max-w-7xl mx-auto overflow-hidden">
      
      {/* Section titre + bouton */}
      <div className="relative flex flex-col items-center justify-center text-center mb-20">
        {/* ✅ Titre bien centré */}
        <H2 className="animate-fade-in-up text-center mb-6">Actualités</H2>

        {/* ✅ Bouton placé un peu plus bas à droite */}
      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-12 mb-20 lg:mb-32">
       ...
       {/* Image */}
  <div className="w-full xl:w-1/2 flex justify-center group">
...
<div className="w-full mt-10 xl:mt-0 flex justify-center items-center">
    
  
    <div className="w-full max-w-md md:max-w-lg rounded-2xl shadow-xl p-[2px] 
                    bg-gradient-to-r from-[#8a2be2] to-[#6c63ff] h-auto">
            ...
            <div className="text-black px-2">
               ...
               <p className="text-sm sm:text-base text-gray-800 leading-relaxed text-left">
                  ...
                  <span className="font-extrabold bg-gradient-to-r from-[#8a2be2] to-[#6c63ff] text-transparent bg-clip-text">
                      STEPIC
                  </span>, là où savoir et créativité se rencontrent !
                  Chaque jour, plongez au cœur des tendances, des innovations et des actualités qui façonnent le monde numérique et créatif.
                  Avec{" "}
                  <span className="font-extrabold bg-gradient-to-r from-[#8a2be2] to-[#6c63ff] text-transparent bg-clip-text">
                      STEPIC
